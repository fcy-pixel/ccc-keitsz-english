...
('s4', 'Sentence Builder Blocks 🧱', 'Mr. Ho', 'P3', 'Writing', 'https://example.com/sentence-blocks', 'Drag word blocks to build super sentences with subjects, verbs and objects. Three challenge levels!', '["drag-and-drop","challenge"]', 1765500000004),
